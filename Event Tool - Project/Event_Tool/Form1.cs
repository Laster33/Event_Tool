...
namespace Event_Tool {
    ...
    public partial class Form1 : Form {
        ...
        public Form1() {
            ...
            checks1 = new CheckBox[] { budget1, politic1, stabil1, radical1, army1, global1, east1, west1, military1, cult1 };
            checks2 = new CheckBox[] { budget2, politic2, stabil2, radical2, army2, global2, east2, west2, military2, cult2 };
            checks3 = new CheckBox[] { budget3, politic3, stabil3, radical3, army3, global3, east3, west3, military3, cult3 };
            checks4 = new CheckBox[] { budget4, politic4, stabil4, radical4, army4, global4, east4, west4, military4, cult4 };
        }
